...
function createBarGradient(start, end) {
    return {
        type: "linear",
        x: 0,
        y: 0,
...
export function getMonthlyTrendOption(data) {
    return {
        tooltip: {
            trigger: "axis",
        ...
        series: [
            {
                ...
                areaStyle: { color: createAreaGradient("#2F6BFF") },
            ...
            },
            {
                ...
                areaStyle: { color: createAreaGradient("#00A2AD") },
                data: data.map((item) => item.count),
            },
        ],
    };
}
export function getExpenseCategoryOption(data) {
    return {
        tooltip: {
            trigger: "item",
            formatter: "{b}<br/>{c}%",
...
export function getVendorRankingOption(data) {
        ...
        series: [
            {
                ...
                barWidth: 12,
                itemStyle: {
                    color: createBarGradient("#1BC0CB", "#2F6BFF"),
                    borderRadius: [999, 999, 999, 999],
                },
                label: {
                    show: true,
...
export function getResourceFlowOption(data) {
    return {
        tooltip: {
            trigger: "item",
            formatter: "{b}<br/>{c}%",
...
export function getInvestmentCompareOption(data) {
    return {
        ...
        series: [
            {
                ...
                data: data.map((item) => ({
                    value: item.value,
                    itemStyle: {
                        color: createBarGradient(item.color, "#E6F0FF"),
                        borderRadius: [14, 14, 0, 0],
                    },
                })),
                barWidth: "38%",
...
export function getStructureTrendOption(data) {
    return {
        tooltip: {
            trigger: "axis",
            backgroundColor: "rgba(15, 23, 42, 0.88)",
